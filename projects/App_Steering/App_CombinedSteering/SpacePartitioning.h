...
public:
	...
	void RegisterNeighbors(const Elite::Vector2& targetPos, float queryRadius,bool debugRender, bool first);
...
private:
	...
	Elite::Rect GetRectFromPosRadius(const Elite::Vector2& centerPoint, float queryRadius) const;
};
